 ...
 */
        ...
        //                                           unsigned int  multimedia);
                ...
                [DllImport(@"Unmanaged Resources\zzlib.dll")]
        // ReSharper disable InconsistentNaming
        private static extern unsafe int ZzCompressBlock(
...
//__declspec (dllimport) int ZzUncompressBlock(unsigned char *buffer);
        ...
        [DllImport(@"Unmanaged Resources\zzlib.dll")]
        // ReSharper disable InconsistentNaming
        private static extern unsafe int ZzUncompressBlock(
            // ReSharper restore InconsistentNaming
            byte* source);
        ...
        */
        ...
        ///-------------------------------------------------------------------------------------------------
        public BwtStream(Stream stream, CompressionMode mode)
        ...
        ///-------------------------------------------------------------------------------------------------
        private BwtStream(Stream stream, CompressionMode mode, bool leaveOpen)
        {
            _recordsread = 0;
            if (stream == null)
        ...
        private unsafe void DequeueWriteData()
        {
            ...
            _compressed = new byte[buffsize + 16];
            ...
            fixed (byte* source = _compressbuff, destination = _compressed, scratch = _scratchCompress)
            {
                ...
                st.Start();
                _dstlen = (int) ZzCompressBlock(source, buffsize, 0, 1);
                st.Stop();
